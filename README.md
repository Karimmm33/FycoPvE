...
| **Custom server gear** | Records every vendor you open (items, stats, cost) and your BiS items' stats on *this* server. From that, a server pack adds custom pieces that beat the guide's to your BiS lists, marked as custom. Packs are on only on their own server (or as you choose). |
