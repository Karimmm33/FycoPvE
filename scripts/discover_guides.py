...
def main():
    ...
    out = {
        "_comment": "Generated by scripts/discover_guides.py. Every BiS list the build imports. 'snapshot' pins "
                    "an archive.org capture, because wowhead.com/wotlk guides now redirect to the Cataclysm "
                    "versions. Re-run discover_guides.py for newer captures, then build_data.py.",
        "guides": guides,
    }
